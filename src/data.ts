export const projetData = [
	{
		name: "riscv",
		description: `Nous avons crée en duo un émulateur en architecture riscv en rust.
		Nous avons donc simulé une mémoire et un processeur afin de pouvoir faire des calculs en utilisants les instructions données par l'architecture riscv.`,
		imgUrl: "",
		projectUrl: "https://gitlab.univ-lille.fr/s5.01/projet-emulateur",
	},
	{
		name: "Doctolib",
	...
	{
		name: "Shoot'em up Javascrip",
		description: `Ce projet est un shoot'em up écrit en JavaScript. 
                                    Dans ce jeu, nous contrôlons un personnage, et nous devons survivre aux ennemies qui apparaissent en boucle sur le jeu. 
                                    Nous pouvons pour cela tirer des projectiles pour nous défendre, et récupérer des bonus pour survivre plus longtemps. 
                                    Ce jeu est multijoueur, plusieurs personnes peuvent se connecter en même temps grâce à un serveur qui s'occupe de tous les calculs. 
	...
	},
	{
		...
		description: `Le jeu Chasse au Monstre est un jeu programmé en java où 2 joueurs s'affrontent dans un labyrinthe 
                                    Un monstre, qui a pour but de s'échapper du labyrinthe qu'il connaît entièrement, 
                                    et un chasseur qui doit trouver le monstre dans un labyrinthe qu'il ne connaît pas. 
                                    Les joueurs jouent chacun à tour de rôle. 
	...
	{
		name: "Projet agile",
		description: `Le mini-projet agile visait à nous apprendre les méthodes de développement agile.
                                    Nous étions en groupe de 4 ou 5 personnes et devions coder un jeu en équipe en 3 jours.
	...
	{
		name: "Application d’échange internationale",
		description: `L'application d'échange était un projet de création d'application.
                                    ...
                                    et un côté professeur pour mettre en relation les élèves ayant le plus d'affinités.
	...
	{
		name: "Plateforme de covoiturage en ligne",
		description: `La plateforme de covoiturage en ligne était un projet de site Internet.
                                    Nous étions en groupe de 3 ou 4, et nous devions créer un site pour une entreprise
                                    qui souhaitait que ses employés se déplacent en covoiturage. 
